...
- SUPPLY-001D10 → [#459](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/459)
...
| 3 | SUPPLY-001 | Remove vulnerable dependency chains and stage SDK/build upgrades | P0 | L | partial: A/#127 and B/#192 delivered; C source/tests tracked by #202; D8/#453 and D9/#455 delivered; D10 tracked by #459; remaining D–G work open | CI-001 baseline |
...
| 11 | PAY-001 | Add strict request schemas and immutable monetary snapshots | P0 | L | partial: PAY-001A complete in [#157](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/157); race request/event-field adoption tracked in PAY-001B1 [#219](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/219); merchandise request/option adoption tracked in PAY-001C1B [#389](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/389); merchandise price-snapshot/multi-quantity adoption tracked in PAY-001C1C [#393](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/393); snapshots and remaining B/C/D work open | ABUSE-001 interface agreed |
...
| 17 | PAY-004 | Make cancellation authoritative and replace reusable late Payment Links | P0 | L | C1 source containment tracked in [#359](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/359); full replacement proposed; not deployed | PAY-002, PAY-003, RACE-001 |
...
| 24 | WEB-001 | Move to controlled hosting and add browser security policy | P1 | L | static staging active through #460/#663/#665; production cutover blocked | SAFETY-001, CI-001 |
...
- Java 21 + exact Firebase CLI 15.24.0: credential-free, demo-only Auth/Firestore/Functions readiness and loopback-port smoke. Java 17 now rejects before emulator startup.
...
Do not redesign routing or hosting in this issue; WEB-001 owns that. WEB-001A1 [#663](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/663) makes ordinary optimized previews select a reserved synthetic staging configuration. WEB-001A2 [#665](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/665) adds an owned static Hosting stage, but private preview behavior remains blocked because its backend and outside-provider isolation are not configured under #105/CONFIG. Firebase emulators do not make Stripe, Strava, or email safe. ABUSE-001A must explicitly defer App Check enforcement on `lookupRegistration`, `lookupOrder`, and `stravaExchangeCode` while the initial capability guard is active. DATA-001A owns the two payment-confirmation handoffs; OAUTH-001C within live [#88](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/88) owns the Strava exchange handoff. Do not weaken the guard. Do not include any real callback token in fixtures. #118 still owns the reported profile failure.

---

## CI-001 — Repair test gates and secure the deployment pipeline

**COST-001 source child:** [#683](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/683) binds only the two profile Functions to zero reserved instances, max two each, 256 MB and 30 seconds, with actual SDK metadata tests and matching fail-closed provider readback validation. It records the community-first minimal-service direction and officer review procedure without changing schema, privileges, deployment scope, billing, providers, or public pages. This is source preparation, not reduced-bill or hosted quality evidence; #113/#133/#136 retain release prerequisites, synthetic cold-start/burst/recovery proof and compatible rollback.

**Labels:** `priority:P0`, `type:security`, `type:testing`, `area:ci`, `size:L`, `needs-external-config`
**Status:** Published as tracker [#105](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/105). [#103](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/103), [#124](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/124), and [#126](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/126) provide the local/hosted frontend and SPA baselines. CI-001B3 [#167](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/167) owns the dedicated hosted command-journal Firestore transaction gate. CI-001B4 [#186](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/186) merged through [PR #189](https://github.com/Run-MPRC/Run-MPRC.github.io/pull/189) as exact main `bec7d5e365eacb418563a172029f241f660d9768`; exact PR run `29291402007` and post-merge run `29291515653` passed. CI-001B4A [#227](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/227), CI-001B4B [#239](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/239), and PAY-004C1 [#359](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/359) are focused reviewed reductions of that ledger. [PR #391](https://github.com/Run-MPRC/Run-MPRC.github.io/pull/391) and [PR #392](https://github.com/Run-MPRC/Run-MPRC.github.io/pull/392) add three TypeScript files while retiring four TSX errors during functional work. CI-001B4C [#449](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/449) retires four stale unknown-rule directive records through comment-only same-line substitutions. MEMBERS-CONTENT-001B [#492](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/492) removes one finding-free dormant JSX file. The gate now records 110 files, 113 configured errors, and 6 warnings. [#135](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/135) owns the manual exact-commit, backend-first source gate and Git-triggered Netlify production containment. [#133](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/133) owns protected OIDC/environment configuration, and [#136](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/136) owns the actual profile-recovery release. Branch-required-check configuration, scanning, staging/live evidence, remaining lint-debt cleanup, and protected Netlify publication remain open, so the pipeline is still non-compliant overall.
**Depends on:** SAFETY-001

**Current CI-001C boundary:** CI-001C1 [#667](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/667) supplies the staging-only protected read-only OIDC proof: exact immutable repository/owner IDs, `main`, the `staging` environment, one verifier workflow, two named individual reviewers, and a keyless principal with only project-identity read permission. Parent #133 still owns Firebase deployment roles and production protection; #136 still owns an actual backend release.

**Current CI-001D boundary:** CI-001D1 [#669](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/669) supplies the first staging data boundary: empty Native/Standard `(default)` Firestore in `us-west2`, delete protection enabled, PITR disabled, and exact Rules/indexes from `ee16bd16220ab58bd3a2add80dd2f39a1d514dd7`. The 418-case Rules suite passed, provider definitions matched, fixed anonymous server-only reads were denied, and root collection count remained zero. CI-001D2 [#671](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/671) deploys the email/password-only Auth contract from exact merged source `42542303d043f87a8f1a04be2f0b4f2a88e0318c`. Provider readback and disposable API/browser checks prove password-required sign-in, improved email privacy, only staging domains, no other provider, billing disabled, and final cleanup to zero users/records. CI-001D3 [#674](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/674) adds a source-only, argument-closed command for exactly `createMemberOnSignUp` and `ensureMemberProfile`; its tests reject broad/partial targets, another project/account, a credentials file, changed exports/scripts, extra arguments, and an unpinned CLI. Read-only preflight found project Owner authority, billing disabled, and zero open billing accounts visible to the club account. No Function/API/billing/data/provider mutation is part of #674. CI-001D4 [#676](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/676) merges its argument-closed Hosting command through PR #677 as exact source `bce911a7083201cfe2141edaa9660f210287bf57`; all five post-main CI jobs passed. The bounded provider phase enabled only Firebase App Check and reCAPTCHA Enterprise, created exactly one score-based key restricted to the two staging hosts, registered it to the one web app with a one-hour token lifetime, and published that exact source as Hosting version `8556fc51210bdc66`. A reserved-domain disposable browser identity proved create, sign-out, fresh sign-in, and post-enforcement sign-in; token-bearing Events reads stayed successful signed in and signed out. Authentication plus Firestore now read `ENFORCED` with replay protection `OFF`; tokenless Auth and Firestore probes were rejected with HTTP 401 and 403. Cleanup returned users and root collections to zero. Billing is disabled, no Functions-related API or Function exists, the account profile remains fail-closed until those Functions are deployed, and production is unchanged. Parent #133 still owns keyless Firebase deployment roles and production protection; #136 still owns the compatible synthetic backend release.

### Problem

Before #103, frontend tests failed because the Jest environment lacked `TextEncoder`. That child repaired the local baseline, and #124 adds it to hosted CI. #167 originally added a separate named Node 20/Java 17 job for the PAY-002B2A Firestore transaction suite and made both protected-release CI reads require it. SUPPLY-001D9/#455 moves the current source to Java 21 and exact Firebase CLI 15.24.0 while preserving one explicit demo project, Firestore-only scope, committed lockfiles, and no cloud/provider authority. CI-001B4/#186 replaces the mutating, ignored `lint:fix` step with a blocking exact-record check that initially covered 102 JS/JSX/TS/TSX files. It disables the repository-wide severity-masking `eslint-plugin-only-warn` hook inside the lint process. CI-001B4A/#227 removes exactly one reviewed `arrow-body-style` record without changing the rule or gate. CI-001B4B/#239 removes exactly one stale `AdminMembers` unknown-rule suppression record without changing executable statements, the rule set, or the gate. PAY-004C1/#359 removes one `no-alert` warning and two label-association errors by removing the obsolete reusable-link prompt and amount/tier controls. Intervening reviewed source additions expanded coverage from 102 to 108 files by #359. PR #391 then adds one TypeScript file and removes two TSX errors; PR #392 adds two TypeScript files and removes two more TSX errors. CI-001B4C/#449 replaces the four remaining stale `react-hooks/exhaustive-deps` directives with ordinary comments on the same lines, preserving every executable statement and dependency array. MEMBERS-CONTENT-001B/#492 then removes one finding-free dormant JSX file. The gate therefore scans 110 files and records 113 configured errors and 6 warnings as reviewable individual records. Any added, removed, moved, or changed record and every fatal parser/configuration failure rejects with one fixed diagnostic. The checker runs directly before application tests in an exact prefix that pins the hosted runner, read-only permission, credential-free checkout, Node version, lifecycle-disabled install, lint, and adjacent clean check. Global overrides and prefix changes reject. The clean check compares tracked files with `HEAD` plus non-ignored untracked files; ignored dependency/build paths are outside that proof. This is an explicit debt baseline, not a clean-lint claim. #135 removes the automatic/fail-open release source defects: merge and release are separate, exact CI checks are re-read, release targets are fixed, OIDC replaces JSON-key wiring, lockfile tooling is used, backend precedes Pages, and Git-triggered Netlify production builds stop. The protected identity/environments and actual staged/live release remain outside that source slice.
...
- [ ] Rules and commerce-emulator tests run with Java 21 and include the deny/concurrency assertions from SEC-001 and PAY-002B2.
...
**Status:** Partial; SUPPLY-001A is represented by [#127](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/127), SUPPLY-001B by [#192](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/192), SUPPLY-001C source/tests by [#202](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/202), focused SUPPLY-001D8 by [#453](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/453), Firebase CLI/Java compatibility SUPPLY-001D9 by [#455](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/455), and the compatible brace-expansion repair SUPPLY-001D10 by [#459](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/459); the main D–G upgrades remain open
**Depends on:** CI-001A

### Problem

The 2026-07-12 baseline production audit reported 33 root advisories (3 critical, 9 high) and 9 Functions advisories (1 high). SUPPLY-001A/#127 removes the unused `gpxparser` and obsolete `jsdom/request/form-data` chain; on a fresh Node 20 install, the root production audit falls to 22 advisories (1 critical, 8 high) while production bundle hashes remain identical. SUPPLY-001B/#192 pins the compatible React Router 6.30.4 graph and removes all three router findings, reducing that root audit to 19 advisories (1 critical, 5 high). SUPPLY-001C/#202 pins the last Firebase 11 compatibility release and its matching Rules helper; its fresh production audit reports 6 advisories (0 critical, 3 high). Later focused lock repairs reduce the exact-main snapshot to 4 findings (3 high, 1 low) before SUPPLY-001D8/#453; D8 removes the high-severity SystemJS compiler finding through an already-compatible parent range. SUPPLY-001D9/#455 then removes the two critical full-audit groups retained by the development/release Firebase CLI and migrates the emulators to Java 21. SUPPLY-001D10/#459 updates every affected root brace-expansion 1.x, 2.x, and 5.x lock resolution through existing parent ranges to the compatible follow-up releases that close the cumulative-output bypasses in the first GHSA-mh99-v99m-4gvg patches. Its clean audit removes one high group, but the legacy minimatch copies remain behaviorally unresolved even where current advisory metadata labels later 3.x/5.x releases patched. Firebase Admin/Functions still need a staged major upgrade, Create React App remains unmaintained, and the genuine minimatch migration plus compiler/scanning-policy work remain open.
...
4. [#455](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/455): pin Firebase CLI 15.24.0 and migrate all repository-owned emulator gates to Java 21 without changing Firebase application or provider behavior.
5. [#459](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/459): update only the fifteen compatible brace-expansion 1.x, 2.x, and 5.x lock records, pin every installed family, bound cumulative output, and keep the separate minimatch migration explicit.
6. Upgrade Firebase Admin/Functions with emulator and Auth/Firestore trigger tests.
7. Upgrade Stripe SDK and deliberately select/test the Stripe API version.
8. Plan and execute CRA migration to a maintained build tool without mixing payment behavior changes.
9. Add automated dependency updates, audit policy, reviewed lockfiles, and an SBOM/release inventory.
...
- SUPPLY-001D9/#455: pin exact Firebase CLI 15.24.0 and move both hosted emulator jobs from Java 17 to Java 21. The major adds 194 package records, removes 116, and changes 62 retained records; the root lock diff is +4,040/-2,574 lines. Pub/Sub moves from 3.7.5 to 5.3.1, google-gax from 3.6.1 to 5.0.7, the affected nested `protobufjs` path disappears, and `tar` moves from 6.2.1 to 7.5.21. A clean Node 20 full audit changes from 64 findings (2 critical, 32 high, 17 moderate, 13 low) to 58 (0 critical, 24 high, 21 moderate, 13 low); the production-only audit remains 2 high and 1 low. Java 17 rejects before emulator startup. Java 21 passes 378/378 Rules tests, 63/63 commerce concurrency tests, and a credential-inaccessible Node 20 `demo-mprc-local` readiness smoke for Auth, Firestore, and Functions. Clean baseline and upgraded builds are byte-for-byte identical across all 59 files and 19,520,717 bytes. Functions source, manifest, lockfile, and audits remain unchanged. Remaining root and Functions findings are not accepted as safe.
- SUPPLY-001D10/#459: keep `package.json` byte-identical while moving twelve brace-expansion 1.x records at 1.1.11, 1.1.12, or 1.1.14 to 1.1.18, both 2.x records from 2.1.2 to 2.1.4, and the sole 5.x record from 5.0.5 to 5.0.9. Exactly 15 package records change. Their version, public-registry URL, and integrity fields move; the 5.x record also adopts the maintained release's Node `20 || >=22` engine boundary. A dependency-free RED test pins all 15 locked/installed paths, development classifications, parent ranges, and identities. Bounded child processes retain the earlier non-expanding-brace regressions and cover every installed major family against GHSA-mh99-v99m-4gvg's cumulative-output boundary. Exact current `main` produces 1,024 values totaling 10,240 characters despite `maxLength: 200`, and 500 comma-alternative values despite `maxLength: 50`; the patched families cap those cases at 20/200 and 50/50. A 100,001-character padded sequence stops after one result under `maxLength: 200000`, while ordinary padded sequences, options, and result-limit behavior around empty options remain compatible. The fresh 2026-08-01 Node 20 advisory snapshot on exact current `main` changes from 61 full findings (0 critical, 25 high, 23 moderate, 13 low) to 60 (0 critical, 24 high, 23 moderate, 13 low), and from 5 production-classified findings (2 high, 2 moderate, 1 low) to 4 (1 high, 2 moderate, 1 low). Clean baseline and patched builds are byte-for-byte identical across all 59 files and 19,521,335 bytes; the sorted per-file SHA-256 manifest has aggregate SHA-256 `2bf3ffb8e5d8d9e7ab6fc114a7a9f83c6dcd8a4098a93b2dad8c8d62bf4cf8ce`. Functions manifests and lockfile remain unchanged. The remaining minimatch high group is explicitly unresolved: the audit service's legacy patch labels are not functional proof, and a separately reviewed modern-major compatibility migration is required.

### Agent handoff

Never use `npm audit fix --force`. Do not combine all upgrades in one unreviewable lockfile diff. SUPPLY-001A, B, C, focused D8, CLI/Java D9, and brace-expansion D10 are represented by #127, #192, #202, #453, #455, and #459; do not publish duplicates. #202, #453, #455, and #459 are source/test evidence only: they do not publish the website, deploy Firebase, change provider settings, or prove live behavior. The remaining Babel-core, minimatch, other CLI-transitive, Firebase Admin/Functions, and Functions-lock findings are unresolved and not accepted as safe. Do not claim the legacy minimatch patch floors are sufficient when the maintained behavior test disagrees. Stop if a later provider SDK change needs a product/runtime decision.
...
**Status:** Proposed. WEB-001A2 [#665](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/665) adds static website staging only; it does not deploy or verify scoped capabilities, MFA, recent authentication, Rules, Functions, or operator behavior.
...
**Status:** Partial. PAY-001A source/tests are complete in live [#157](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/157). PAY-001B1 race/volunteer request and event-field adoption is tracked in live [#219](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/219). PAY-001C1B merchandise request and option adoption is tracked in live [#389](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/389). PAY-001C1C merchandise price-snapshot and multi-quantity adoption is tracked in live [#393](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/393). PAY-001B2 snapshots, the rest of PAY-001C, PAY-001D, deployment, and live behavior remain open.
...
PAY-001C1B [#389](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/389) is the first merchandise-checkout endpoint adoption. The website projects only a size or color the product offers. The merchandise callable strict-parses its exact request root — an opaque slug, a bounded buyer, and an optional size and color — before Firestore, commerce admission, rate limits, or Stripe, then matches the selections against the stored catalog option lists before the price projection, Stripe Product binding, or Checkout call. It requires one in-list selection for every offered dimension, rejects a selection for an absent dimension, and returns one fixed non-identifying failure that does not echo the field. A request fault is `invalid-argument`; a malformed stored option list is `failed-precondition`. It replaces the previous inline size/color check and does not add immutable merchandise price snapshots, multi-quantity, persistence-first orders, provider idempotency, deployment, or production protection; those remain **NOT AVAILABLE YET** under the rest of PAY-001C, PAY-001D, and later payment issues. Exact branch, review, merge, and CI evidence belongs to #389.

PAY-001C1C [#393](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/393), stacked on PAY-001C1B, adds bounded multi-quantity and an immutable server-owned price snapshot. The request parser accepts an optional `quantity` (absent means one unit; a present value must be a safe integer in `[1, MAX_MERCH_QUANTITY]`, 25, or it is the same fixed `invalid-argument` denial before any side effect). `projectMerchandisePriceSnapshot` projects the unit price only from the stored product, re-validates the quantity, and recomputes the total under safe-integer and Stripe-minimum guards, collapsing any fault to unavailable rather than charging a guessed amount. The pending order persists `quantity`, `amountCents` (the total, `unit × quantity`, which the webhook money reconciliation requires), `currency`, and an immutable `priceSnapshot`, and the Stripe line item charges `unit_amount × quantity`. The Stripe metadata is unchanged: a `quantity` metadata key is deferred to a PAY-005 follow-up because `parseMetadataInput` enforces an exact-key match. This slice is server-only — the website still sends no quantity, so the single-unit checkout is byte-compatible — and it does not add a browser quantity selector, cart/multi-line, inventory, canonical variant IDs, persistence-first idempotency, deployment, or production protection; those remain **NOT AVAILABLE YET** under the rest of PAY-001C, PAY-001D, and later payment issues. Exact branch, review, merge, and CI evidence belongs to #393.
...
PAY-SESSION-001A [#357](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/357) is an independent immediate containment change in the two existing paid handlers. It does not adopt C4C1/C4C2. Before the current Session call, each handler freezes an exact local expectation for declared mode, amount, USD, email, closed domain metadata, and callbacks. Immediately after that call, one dependency-free projector reads only selected installed-SDK data descriptors and accepts a mode-compatible bounded Session ID, payment/open/unpaid state, the exact business fields and callbacks, one canonical HTTPS URL on the hard-coded default `checkout.stripe.com` origin, and the installed-SDK 200 marker. It returns only a copied Session ID and URL; only the ID is stored. Rejection or mismatch returns one fixed do-not-retry result and creates no registration/order record.

The #357 browser change makes a rejected request or a paid result without a usable URL terminal for the current page visit: the form remains, busy ends, the button stays disabled, and a direct repeated handler call makes no second service call. This is deterrence only; reload, another tab/device, or a scripted caller bypasses it. The provider request still happens before validation, so a rejected result may leave a payable orphan. Earlier rate-counter, token/identifier, and lazy Product-mapping effects may remain. No deterministic business key, provider/account origin proof, current-time binding, durable result persistence, reconciliation, payment proof, custom-domain configuration, C4 adoption, deployment, or live behavior is added.
...
**Status:** Immediate C1 source containment tracked in live [#359](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/359); full replacement proposed; not deployed
...
PAY-004C1 [#359](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/359) is the immediate fail-closed source slice. It disables new positive paid-late-registration requests and removes the reusable-link controls from the Admin screen while the safe one-off design remains unavailable. It does not inventory, deactivate, or reconcile any existing link and is not Firebase, website, Stripe, or live-behavior evidence.
...
- [x] PAY-004C1 source/tests deny every admitted positive late-registration amount before registration allocation, writes, Stripe construction, or Product/Price/Payment Link calls.
- [x] PAY-004C1 source removes paid amount/tier entry and reusable-link prompting from the Admin screen and marks paid late registration **NOT AVAILABLE YET**.
- [ ] Publish and verify the exact website and Firebase revisions before treating that containment as live.
...
**Status:** In progress through tracker [#460](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/460), source foundation [#663](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/663), and static staging [#665](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/665). Production cutover remains blocked.
**Depends on:** SAFETY-001, CI-001

### Problem

GitHub Pages relies on a JavaScript 404 bridge for every deep link and offers limited application-controlled response headers. MEMBERS-CONTENT-001B [#492](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/492) removes the unrouted legacy component that parsed one stored Firestore field with `html-react-parser`, plus that direct parser dependency. It does not migrate or delete legacy content, change Rules, add the structured #83 route, publish the website, or establish a CSP. The app still loads external fonts/images/maps/services, and no deployed CSP, frame-ancestor, referrer, permissions, or nosniff policy is declared.
...
- Extend the dedicated `run-mprc-staging` static project into a protected backend test environment, create and verify the Stripe test/sandbox endpoint, and keep production isolated.
