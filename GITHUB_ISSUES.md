...
| 11 | PAY-001 | Add strict request schemas and immutable monetary snapshots | P0 | L | partial: PAY-001A complete in [#157](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/157); race request/event-field adoption tracked in PAY-001B1 [#219](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/219); merchandise request/option adoption tracked in PAY-001C1B [#389](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/389); snapshots and remaining B/C/D work open | ABUSE-001 interface agreed |
