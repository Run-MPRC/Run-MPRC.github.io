...
- [ ] CI-001B4/#186 implements non-mutating, exact-record frontend lint in source; close only after exact pull-request and post-merge hosted evidence. Branch-required-check settings remain separate.
