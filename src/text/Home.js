...
export const ABOUT_STORY_CONTENT = [
  ...
  "Our club isn't just about hitting the pavement; it's about forging connections and enjoying the outdoors. Picture a group of around 150 friendly locals who share a love for staying active and appreciating the beauty of nature.",
  "Every Saturday morning at 8:45 AM, we have our main run/walk on the Bay Trail in San Mateo. You can choose to run/walk any distance from 4-6 miles. It's a great way to start the weekend! We also have special events just for our members throughout the year, giving us more chances to have fun together.",
