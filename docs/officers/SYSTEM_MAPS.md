...
flowchart TD
    ...
    Main -. "Inactive #457 manifest" .-> WebGate{"Manifest active and release source present?"}
    WebGate -- "No" --> Stop
    WebGate -- "Yes" --> Netlify
