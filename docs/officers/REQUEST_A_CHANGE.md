...
The GitHub release is manual. A `main` merge runs checks but does not publish the GitHub Pages copy or deploy Firebase. Ordinary Git-triggered Netlify production builds are paused by repository configuration. The completed WEB-CONTENT-001 [#685](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/685) website release published temporary-notice deploy `6aa8c5b3fddd040009eba99c` from source `41a9ae4ebc719212df610ff5cdcf9ca4eab18e71`. Its marker and all 62 files matched, signed-out phone/desktop checks passed, and repause attempt `6aa8c78dd7b9d1000952eaa2` published nothing and retained that deploy. The manifest is inactive, temporary #685 source/control/repause refs are absent, and its rollback ref remains. Completed #659 deploy `6a7ece87c5ca4d0007c1a3fc` and source `7496fe0881fb52908c4ff2f40f488df09c94c908` are immediate rollback; completed #623 deploy `6a7e072f8f346b0008510d29` and #473 deploy `6a6dc9ea588b0c0008036312` are older history. The old #473/#623/#659 hot refs remain a documented latent manual-rebuild risk despite inactive manifests. Netlify provider settings remain separately unverified. Stop and escalate any unexpected publication.
