...
13. Confirm ordinary Netlify Git-triggered production builds remain paused. Confirm the completed #457 manifest is inactive, its release source is absent, and only its exact rollback source remains.
