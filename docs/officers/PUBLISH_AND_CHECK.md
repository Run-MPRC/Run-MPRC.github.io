...
**Prerequisites:** approved issue #473 with no newer blocker; green exact-head checks; successful pinned Deploy Preview; source commit `fc25692fc79883f89bf90309654f781b1554e867`; source tree `91a351452af620c09b0a957c5af2c44a88fc1e70`; 60-file digest `07b10c7d5ff176a1ad893d7549b07042312df35f4a4126e8765824ca94eaefb8`; exact first parent `dee79511b6e371329aa129139729e112e7a51aad`; current production deploy `6a6dc219a8136300081811db`; live artifact source `ed1b0833f25822cee80c99ded8753722b5608a3f`, tree `878c6628d961f4484cb49208aef53f1e9f2e3b47`, 60 files, and digest `7570955c2a00926e5813aef135f1799172cfd046072ac89fb4e492bed0797092`; dedicated release source `codex/netlify-source-473-permissions-containment` pinned by exact commit and tree; dedicated rollback source `codex/netlify-source-473-rollback` pinned to that live artifact source; an executable diff proving only the three named pages plus one focused test changed from the live source; a prepared manifest-disable change; a prepared exact Git rollback projection; a named public observer; and no other `main` merge until verification finishes.
...
**Incident evidence:** overbroad source `094af109` was published as deploy `6a6dc0167fbe68000816b448` after a blocker was posted. Rollback merge `1099ee8` published exact prior source `ed1b0833` as deploy `6a6dc219a8136300081811db`. Safety merge `dee79511` re-paused the manifest; its provider attempt did not replace production. The broad source ref was removed. This record is why steps 4 and 11 are mandatory.
