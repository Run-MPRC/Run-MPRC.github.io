...
WEB-002C [#623](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/623) is an active one-shot Netlify release under review, not a completed publication. Its only frontend input is frozen inert source `c2d87d1f69f15e128a0bc9b1b9f915b7c8417aec`, tree `411aa6ec9a9459f5d923030533ffc7c007fe6908`, built as 62 files with digest `d837272a1e5efc1575809e87f532276b38d1a63f1dd79ec1aef0533f6da8afb1`. The release control expects exact first parent `019353361210021483f23003e09ee6924b78e67c`. Until its pinned preview, exact two-parent merge, production marker, signed-out route/network checks, and immediate repause all pass, production remains #473 deploy `6a6dc9ea588b0c0008036312` from source `39ab8649df411262c8109a3c81a57bc38f1e168b`; that same deploy is #623's rollback target. Protected Account and administrator layouts are proved only with synthetic local artifacts. Production checks must stay signed out and can prove only the exact revision, normal sign-in and administrator guards, and absence of a member-directory request. Stop for any source, tree, count, digest, parent, marker, route, network, or repause mismatch. #623 has no authority for Firebase, Rules, Functions, indexes, outside-provider configuration, account/sign-in changes, real names/photos, or production data. Connected behavior remains **NOT AVAILABLE YET** under [#507](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/507). Follow the pending procedure in `docs/officers/PUBLISH_AND_CHECK.md`; do not reuse it as a general release button.
