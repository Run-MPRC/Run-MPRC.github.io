...
WEB-002A [#473](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/473) had a production incident on 2026-08-01. The scope-blocker comment was posted at 09:44:29Z. PR #474 merged 23 seconds later, before that verdict reached the merger, and broad control merge `40728ff6141e34a279b70cc41d983c22ac5f0daa` published Netlify deploy `6a6dc0167fbe68000816b448` from source `094af1096ed8721597561cd59bf695d4c4a9d210`. The verdict proved that artifact exceeded the accepted Shop/Events scope. Do not describe that deployment as WEB-002A success.

Rollback merge `1099ee8e6fdb81141fd9460de175b6d854cbcfdd` then published deploy `6a6dc219a8136300081811db`. Provider readback and the public marker identify exact restored source `ed1b0833f25822cee80c99ded8753722b5608a3f`, tree `878c6628d961f4484cb49208aef53f1e9f2e3b47`, 60 files, and digest `7570955c2a00926e5813aef135f1799172cfd046072ac89fb4e492bed0797092`. Exact-main CI run `30694629574` passed all five jobs. The disputed broad source ref is absent; `codex/netlify-source-473-rollback` remains pinned to the restored source.

Repause merge `dee79511b6e371329aa129139729e112e7a51aad` made the manifest inactive. Netlify attempt `6a6dc35767a4ef000877e74b` stayed unpublished, exact-main CI run `30694803373` passed all five jobs, and deploy `6a6dc219a8136300081811db` remained live. No Firebase, Rules, Functions, provider configuration, account, payment, or production-data action occurred in the rollback or repause.

The incident is contained, but the restored artifact still renders raw Firestore permission text on the signed-out Shop and Events pages. #473 remains open for a new projection based on exact restored source `ed1b0833`. That projection may add only the reviewed static Hat/Jacket pickup Shop, fixed accessible Events-list and Events-calendar failure messages, and focused synthetic tests. It must use a new source commit/tree/digest, preview, prepared rollback, prepared repause, independent reviews, and signed-out live checks. Until all of those exist, the narrow release is **NOT AVAILABLE YET**. It will not repair Events data or authorize a Firebase/Rules/App Check deployment; that backend incident requires a separate protected release.
