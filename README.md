...
**Current Netlify publication checked 2026-09-14 Pacific time:** WEB-CONTENT-001 [#685](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/685) completed one bounded content-only release. Exact merge `d25b0fe497e0179d62c060a2df3e3a7a9a2c68c6` published deploy `6aa8c5b3fddd040009eba99c` from source `41a9ae4ebc719212df610ff5cdcf9ca4eab18e71`, tree `7f75ebda7b9d295c5be26acc11b06b452dcc20c6`, 62 files, and digest `cb4eba76c65c3501b37f9a0ad3cf00b6eefbc5a9c2e653f2b3c03607cfe64850`. The marker and every live file matched. Signed-out 390×844 and 1280×900 checks passed for both temporary meeting notices, exact safe map links, banner and page-heading visibility, and no horizontal overflow; no screenshot was retained. Repause merge `609d7884e0242abce23449562e7e0da04794da1e` passed all five exact-main jobs in run `34928449093`. Attempt `6aa8c78dd7b9d1000952eaa2` errored unpublished with `published_at` null, retained the verified #685 deploy, and left the manifest inactive. The temporary #685 source/control/repause refs are retired; rollback ref `codex/netlify-source-685-rollback` remains pinned to #659 source `7496fe0881fb52908c4ff2f40f488df09c94c908` and deploy `6a7ece87c5ca4d0007c1a3fc`. #623 and #473 are older history. The old #473/#623/#659 hot refs remain a documented latent manual-rebuild risk despite inactive manifests. No Firebase, Pages, DNS, provider, account, sign-in, data, payment, route, or permission changed. The Sept. 12 email is already sent; WhatsApp remains pending action-time confirmation, so issue #685 remains open.
...
Do not use a Netlify preview, locally served optimized `build/`, or `run-mprc-staging` with real identities, private/member records, admin work, or outside-provider actions. WEB-001A1 [#663](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/663) makes optimized builds choose `staging` or `production` explicitly. WEB-001A2 [#665](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/665) verifies the owned static stage, CI-001D1 [#669](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/669) verifies its empty Firestore Rules/index boundary, CI-001D2 [#671](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/671) proves bounded disposable email/password Auth behavior, and CI-001D4 [#676](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/676) enforces App Check for Authentication plus Firestore. Functions and outside providers are still not isolated for end-to-end use; App Check does not authorize member, admin, payment, or provider behavior.
