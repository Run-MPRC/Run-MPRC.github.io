...
Do not use a Netlify preview, locally served optimized `build/`, or `run-mprc-staging` for sign-in, private pages, admin work, or provider testing. WEB-001A1 [#663](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/663) makes optimized builds choose `staging` or `production` explicitly. WEB-001A2 [#665](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/665) verifies the owned static stage, and CI-001D1 [#669](https://github.com/Run-MPRC/Run-MPRC.github.io/issues/669) verifies only its empty Firestore Rules/index boundary. Auth, Functions, App Check, and outside providers are still not isolated for end-to-end use.
